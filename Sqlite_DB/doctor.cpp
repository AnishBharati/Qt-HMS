   ...
   //  phone=ui->txt_phone->text();
    if(!conn.connOpen()){
       ...
       conn.connOpen();
        ...
        QSqlQuery qry;
       qry.prepare("update doctorsinfo set ID='"+id+"',Name='"+name+"',Age='"+age+"',Phone='"+phone+"',Email='"+email+"',Specialist='"+specialist+"' where ID='"+id+"' ");
  /*
        */
       if(qry.exec())
       {
   ...
   //  phone=ui->txt_phone->text();
    if(!conn.connOpen()){
       ...
       conn.connOpen();
        ...
        QSqlQuery qry;
       qry.prepare("delete from doctorsinfo where Id='"+id+"'");
  /*
        */
       if(qry.exec())
       {
